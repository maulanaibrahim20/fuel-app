        ...
        <div class="authentication-inner row">
            ...
            <div class="d-flex col-12 col-lg-5 align-items-center p-sm-5 p-4">
                <div class="w-px-400 mx-auto">
                    ...
                    <form id="form-ajax" action="{{ route('register') }}" method="POST" class="mb-3">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="phone" name="phone"
                                placeholder="Enter your whatsapp number" autofocus />
                        </div>
                        ...
                        <button type="submit" id="btn-ajax" class="btn btn-primary d-grid w-100">Sign up</button>
                    </form>
